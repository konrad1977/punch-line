;;; cocaine-line-term.el --- A customized mode-line for Emacs with modal status and advanced customizations -*- lexical-binding: t; -*-
...
(defface cocaine-term-face
  '((t (:inherit font-lock-variable-name-face)))
  "Face for the terminal icon in the cocaine line."
  :group 'cocaine-line)

(defcustom cocaine-show-term-info t
  "Flag to indicate if the terminal is hidden."
  :type 'boolean
  :group 'cocaine-line)

(defvar cocaine-term-process-name nil
...
(defun cocaine-vterm-last-command ()
